  ...
  return (
    <>
      <div
        className={
          isDownloadPopupOpen
            ? "fixed bottom-4 left-4 z-50 bg-white p-8 rounded-lg max-h-60 w-1/3 dark:bg-gray-700"
            : "hidden"
        }
      >
        <button
        ...
        <h1 className="text-lg font-semibold mb-4 dark:text-gray-200">
          Download Complete
        </h1>
      ...
      >
        <div className="bg-white p-10 rounded-lg w-1/3 shadow-lg dark:bg-gray-700">
          <h1 className="text-center text-lg font-semibold mb-6 dark:text-gray-200">
